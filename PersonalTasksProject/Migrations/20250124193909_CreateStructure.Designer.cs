...
namespace PersonalTasksProject.Migrations
{
    ...
    [Migration("20250124193909_CreateStructure")]
            ...
            modelBuilder.Entity("PersonalTasksProject.Entities.TaskPriorization", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 551, DateTimeKind.Utc).AddTicks(1880));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 551, DateTimeKind.Utc).AddTicks(2269));
            ...
            modelBuilder.Entity("PersonalTasksProject.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 550, DateTimeKind.Utc).AddTicks(5249));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 550, DateTimeKind.Utc).AddTicks(5804));
            ...
            modelBuilder.Entity("PersonalTasksProject.Entities.UserTask", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 550, DateTimeKind.Utc).AddTicks(7529));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasDefaultValue(new DateTime(2025, 1, 24, 19, 39, 8, 550, DateTimeKind.Utc).AddTicks(8079));
